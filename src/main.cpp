...
void setup() {
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    String html = "<!DOCTYPE html><html lang='pl'><head>"
                  ...
                  "    <button type='button' id='pencilBtn' class='btn btn-blue' style='flex:1;display:flex;justify-content:center;align-items:center;' onclick='setTool(1)'><svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round' style='width:22px;height:22px;'><path d='M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z'/><path d='m15 5 4 4'/></svg></button>"
                  "    <button type='button' id='eraserBtn' class='btn btn-red' style='flex:1; opacity:0.5;display:flex;justify-content:center;align-items:center;' onclick='setTool(0)'><svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round' style='width:22px;height:22px;'><path d='m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.9-9.9c1-1 2.5-1 3.4 0l4.4 4.4c1 1 1 2.5 0 3.4l-8.4 8.4c-1 1-2.5 1-3.4 0Z'/><path d='m22 21-2.1-2.1'/><path d='m11 5 9 9'/></svg></button>"
                  "  </div>"
