...
void setup() {
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    String html = "<!DOCTYPE html><html lang='pl'><head>"
                  ...
                  "h1{color:var(--blue);margin:0 0 5px;font-size:1.8em;}"
                  ".subtitle{color:var(--sub);font-size:0.9em;margin-bottom:30px;}"
                  ...
                  ".footer{margin-top:50px;padding:20px;color:var(--sub);font-size:0.85em;border-top:1px solid var(--border);width:100%;max-width:1000px;}"
                  ...
                  "    <div class='icon'><svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M17.5 19a3.5 3.5 0 1 1 0-7c.4 0 .7 0 1 .1A5.5 5.5 0 1 1 14 19H5.5a3.5 3.5 0 1 1 0-7c.4 0 .7 0 1 .1A5.5 5.5 0 1 1 10 21h7.5'/><circle cx='12' cy='9' r='3'/></svg></div><span class='label'>Weather</span><input type='checkbox' name='c4' " + String(showWeather?"checked":"") + "></div>"
